...
## Componentes
- bypass_universal.py: Script Python para enviar progressos via API.
- - explicacao_bypass.txt: Explicacao tecnica detalhada.
 
  - ## Como usar
  - 1. Abra o console do navegador (F12) na pagina da aula.
